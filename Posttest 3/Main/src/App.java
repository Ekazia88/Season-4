...
public static void create() throws IOException{
    ...
    if(Menu == 1){
        ...
        Console console = new Console(Nama,id,Harga,Stok,Tanggal_rilis,Supplier,kondisi,versi);
        ...
        System.out.print("Masukkan Tanggal Rilis : ");
        String Tanggal_rilis = br.readLine();
        Game game = new Game(Nama,id,Harga,Stok,Tanggal_rilis,Genre,Platform);
        Games.add(game);
        System.out.print("\033[H\033[2J");
        System.out.flush();
        System.out.println("========== Data Toko Game Zeyr ==========");
        ...
        if(Consoles.size() == 0 ){
            ...
            for(i= 0; i < Consoles.size(); i++){
                ...
                if(console.getName().equals(Cari)){
                    ...
                    Console consoleupd = new Console(Namabaru,idbaru,Hargabaru,Stokbaru,Tanggal_rilisbaru,Supplierbaru,kondisibaru,versibaru);
        ...
        if(Games.size() == 0){
            ...
            for(i= 0; i < Games.size(); i++){
                ...
                if(game.getName().equals(Cari)){
                    ...
                    System.out.print("Masukkan Tanggal Rilis baru : ");
                    String Tanggal_rilisbaru = br.readLine();
                    Game gameupd = new Game(Namabaru,idbaru,Hargabaru,Stokbaru,Tanggal_rilisbaru,Genrebaru,Platformbaru);
                    Games.set(i,gameupd);
                    System.out.print("\033[H\033[2J");
                    System.out.flush();
                    System.out.println("========== Data Toko Game Zeyr ==========");
